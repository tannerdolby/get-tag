...
function isObject(obj: Attributes | undefined | null) {
  if (!obj) return false;
 ...
 */
function getTag(tag: string, textContent?: string | null, attributes?: Attributes | null, selfClosing?: boolean, trailingSlash?: boolean): string {
